...
class TestUserSerializers(TestCase):
    ...
    def setUp(self):
        ...
        self.user2 = User.objects.create_superuser(email="test2@gmail.com", password="55555")
...
class TestSearchHistorySerializer(TestCase):
    ...
    def test_search_history_serializer(self):
        ...
        compares_data = {'id': self.history_test_unit1.id, 'user': 'test1@gmail.com',
                         'user_id': self.user1.id, 'departure_city': 'AMS',
                         'arrival_city': 'IEV', 'departure_date': '2021-03-12T00:00:00Z',
                         'arrival_date': '2021-04-12T00:00:00Z'}
        self.assertEqual(serializes_data.data, compares_data)
...
class TestFlightSearchSerializer(TestCase):
    ...
    def test_flight_search_serializer(self):
        ...
        compares_data = {'departure_airport': 'IBZ', 'arrival_airport': 'AMS', 'departure_date': '2021-06-06',
                         'direct_flight': True}
        self.assertEqual(serializes_data.data, compares_data)
