...
class UserViewTest(APITestCase):
    def setUp(self):
        ...
        self.user3 = User.objects.create_superuser(
            email="test3@gmail.com", password="55555"
        )
    ...
    def test_get_all(self):
        ...
        self.assertEqual(
            UsersListSerializer([self.user1, self.user2, self.user3], many=True).data,
            response.data,
        )
...
class SearchHistoryViewTest(APITestCase):
    ...
    def test_get_search_history_all(self):
        ...
        self.assertEqual(
            SearchHistorySerializer(
                [self.history_test_unit1, self.history_test_unit2], many=True
            ).data,
            response.data,
        )
    ...
    def test_get_search_history_pk(self):
        ...
        self.assertEqual(status.HTTP_200_OK, response.status_code)
        self.assertEqual(
            SearchHistorySerializer(self.history_test_unit1).data, response_dict
        )
...
class FlightSearchViewTest(APITestCase):
        ...
        [
            {
                ...
                "ArrivalAirport": "IST",
                "DepartureTime": "2021-06-06T23:15:00",
            ...
            },
            {
                ...
                "ArrivalAirport": "MAD",
                "DepartureTime": "2021-06-07T07:10:00",
            ...
            },
            {
                ...
                "ArrivalAirport": "IBZ",
                "DepartureTime": "2021-06-08T15:05:00",
        ...
        [
            {
                ...
                "DepartureAirport": "AMS",
                "ArrivalAirport": "IBZ",
                "DepartureTime": "2021-06-06T05:50:00",
            ...
            },
            {
                ...
                "DepartureAirport": "AMS",
                "ArrivalAirport": "IBZ",
                "DepartureTime": "2021-06-06T12:00:00",
    ...
    def test_start_get_air_info_not_direct_flight(self):
        ...
        result = unit.start_get_air_info(
            air_company="Test1", request_data=self.test_data1
        )
    ...
    def test_start_get_air_info_with_direct_flight(self):
        ...
        unit.flight_info = self.test_response_data
        result = unit.start_get_air_info(
            air_company="Test1", request_data=self.test_data2
        )
...
class TestSearchAirRoute(APITestCase):
    def setUp(self):
        ...
        self.request_data = {
            ...
            "arrival_airport": "Ibiza Airport (IBZ), Ibiza, ES",
            "departure_date": "2021-06-06",
        }
    ...
    def test_post_user_authenticated(self):
        ...
        self.assertEqual(
            SearchHistory.objects.get(user_id=self.user.id).departure_city, "AMS"
        )
