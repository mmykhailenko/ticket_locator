...
class SearchAirRoute(
    ...
    def post(self, request):
        ...
        request_post["departure_airport"] = request_post["departure_airport"].split(
            ","
        )[0][-4:-1]
        request_post["arrival_airport"] = request_post["arrival_airport"].split(",")[0][
            -4:-1
        ]
        ...
        if form.is_valid():
            ...
            return render(
                request, "hello_world/index.html", {"result": result, "form": form}
            )
        return redirect("/")
...
class Login(View):
    def get(self, request):
        ...
        context = {"result": "init", "form": form}
        return render(
            request=request, template_name="hello_world/login.html", context=context
        )
