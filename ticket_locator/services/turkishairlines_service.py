...
class TurkishAirlinesService(AirCompanyService):
    ...
    _params = {
        ...
        "RoutingType": "M",
        "PassengerTypeQuantity": [{"Code": "adult", "Quantity": 1}],
    ...
    def _get_flight_data(route_data):
        response_map = {
            "Airline": route_data["OperatingAirline"]["CompanyShortName"],
    ...
    def get_flight_info_by_date(
        ...
        if response.status_code == 200:
            ...
            if response_json["status"] == SUCCESS:
                segments = response_json["data"]["availabilityOTAResponse"][
                    "createOTAAirRoute"
                ]["OTA_AirAvailRS"]["OriginDestinationInformation"][
